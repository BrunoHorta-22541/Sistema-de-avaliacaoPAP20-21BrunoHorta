                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tr">
                                                                                        ...
                                                                                        <td colspan="10" style="font-size: 20px;" ><b>Auto Avaliações</b></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        ?>
                                                                                            ...
                                                                                            <td  colspan="9" style="background:<?php echo $cor; ?>; text-align: center"><?php echo "Auto Avaliação "; ?></td>
                                                                                        ...
                                                                                        <tr style="line-height: 0px">
                                                                                            ...
                                                                                            <?php 
                                                                                                $sqI2="select * from autoavaliacao where naluno=$naluno";
                                                                                                ...
                                                                                                if($resultsqI2->num_rows>0){
                                                                                                    ...
                                                                                                    // print_r($row);
                                                                                                    $notas=$row2['notaautoavaliacao'];
                                                                                                    
                                                
                                                                                                        
                                                                                                ?>
                                                                                                
                                                                                                    <td  colspan="9" style="text-align: center"><?php echo $notas;?></td>
