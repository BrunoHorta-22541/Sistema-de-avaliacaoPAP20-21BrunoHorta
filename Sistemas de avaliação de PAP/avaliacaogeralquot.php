                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="col-lg-12 ">
                                                                ...
                                                                <ul class="nav nav-tabs md-tabs " role="tablist">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>Avaliações</a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                ...
                                                                <div class="tab-content card-block">
                                                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                                                        ...
                                                                        <form class="form-horizontal "action="funcaoavaliacaogeral.php" method="post" enctype="multipart/form-data">
                                                                            <hr>
                                                                        <fieldset>
                                                                               
                                                                                <!-- Form Name -->
                                                                                <legend>Inserir Avaliação Geral</legend>
                                                                                ...
                                                                                <div class="col-md-10">
                                                                                    ...
                                                                                    <option value="Trabalho_desenvolvido_Ano">Trabalho desenvolvido ao longo do ano</option>
                                                                                    </select>
                                                                                </div>
                                                                                </div>
                                                                    ...
                                                                    <form class="form-horizontal" action="funcaoavaliacaogeraledit.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                                                                    <fieldset>
                                                                    <legend>Atualizar Avaliação Geral</legend>
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table table-hover">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <?php
                                                                                                            include "config.php";
                                                                                                            $sql = "select * from avaliacaogeral "; 
                                                                                                            $result=$conn->query($sql);
                                                                                                            $i=0;
                                                                                                                if($result->num_rows>0){
                                                                                                                    //output data of each row
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <?php 
                                                                                                                    include("config.php");
                                                                                                                    $sql2 = "select * from curso where idcurso='$curso'";  
                                                                                                                    $result2=$conn->query($sql2);
                                                                                                                    ?>
                                                                                                                    <?php if($result2->num_rows>0){
                                                                                                                    //output data of each row
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <?php
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td><?php echo $Nome." ".$ciclo; ?></td>
                                                                                                                    <?php }} ?>
                                                                                                                    <td><a href="?pap=avaliacaogeral&id=<?php echo $id_criterio?>"><i class="ti-pencil"></i></a></td>
                                                                                                                    <td><a href="funcaoavaliacaogeraldel.php?id=<?php echo $id_criterio?>"><i class="ti-close"></i></a></td>
                                                                                                                </tr>
                                                                                                                    <?php
                                                                                                                    }
                                                                                                                }?>
