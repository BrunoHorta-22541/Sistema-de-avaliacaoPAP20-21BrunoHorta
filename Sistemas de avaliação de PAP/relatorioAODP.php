                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tr">
                                                                                        ...
                                                                                        <td colspan="10" style="font-size: 20px;" ><b>PAP (Apresentação Oral e Defesa do Projeto)</b></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <?php 
                                                                                        $sqI="SELECT DISTINCT(nome) as nome  FROM `criterios` WHERE `fase`='Apr_Oral_Defesa_Projeto' order by nome asc";
                                                                                        ...
                                                                                        <tr style="line-height: 0px">
                                                                                            ...
                                                                                            <?php 
                                                                                                $sqI2="select * from preprojeto JOIN criterios ON preprojeto.idcriterio=criterios.idcriterio where preprojeto.Nutilizador=$naluno and criterios.fase='Apr_Oral_Defesa_Projeto'";
