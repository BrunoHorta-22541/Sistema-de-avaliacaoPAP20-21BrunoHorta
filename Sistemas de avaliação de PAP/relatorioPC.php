                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tr">
                                                                                        ...
                                                                                        <td colspan="13" style="font-size: 20px;" ><b>PAP (Prova Criativa)</b></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <?php
                                                                                        ...
                                                                                        <td colspan="12" style="background-color:#33ccff;" ><b><?php echo $nome; ?></b> </td>
                                                                                        
                                                                                    </tr>  
                                                                                    <tr style="line-height: 0px">
                                                                                        <td colspan="1" ><b>Ciclo de Formação</b> </td>
                                                                                        <td colspan="12" style="background-color:#33ccff;" ><b><?php echo $ciclo; ?></b></td>

                                                                                    </tr> 
                                                                                    <tr style="line-height: 0px">
                                                                                        <td colspan="1" ><b>Ano Létivo</b> </td>
                                                                                        <td colspan="12" style="background-color:#33ccff;" ><b><?php echo $anoletivo; ?></b> </td>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <?php 
                                                                                        $sqI="SELECT DISTINCT(nome) as nome  FROM `criterios` WHERE `fase`='Prova_Criativa_cozinha' order by nome asc";
                                                                                        ...
                                                                                        <tr style="line-height: 0px">
                                                                                            ...
                                                                                            <?php 
                                                                                                $sqI2="select * from preprojeto JOIN criterios ON preprojeto.idcriterio=criterios.idcriterio where preprojeto.Nutilizador=$naluno and criterios.fase='Prova_Criativa_cozinha'";
