                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tr">
                                                                                        ...
                                                                                        <td colspan="10" style="font-size: 20px;" ><b>PAP (Sumário Executivo e Video)</b></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <?php 
                                                                                        $sqI="SELECT DISTINCT(nome) as nome  FROM `criterios` WHERE `fase`='Sumario_Executivo_Video' order by nome asc";
                                                                                        ...
                                                                                        <tr style="line-height: 0px">
                                                                                            ...
                                                                                            <?php 
                                                                                                $sqI2="select * from preprojeto JOIN criterios ON preprojeto.idcriterio=criterios.idcriterio where preprojeto.Nutilizador=$naluno and criterios.fase='Sumario_Executivo_Video'";
