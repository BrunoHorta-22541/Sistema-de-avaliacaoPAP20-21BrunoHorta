                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tr">
                                                                                        ...
                                                                                        <td colspan="10" style="font-size: 20px;" ><b>PAP (Trabalho Desenvolvido Ao Longo do Ano)</b></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        $r=random_int(1,49);
                                                                                        $cor=$colors[$r];
                                                                                        $criteriogeral=$criteriogeral."<br>"."C ".$c." -> Trabalho desenvolvido ao Longo do Ano";    
                                                                                        ?>
                                                                                        ...
                                                                                        <tr style="line-height: 0px">
                                                                                            ...
                                                                                            <?php 
                                                                                                $sqI2="select * from trabalhodesenvolvido where numeroaluno=$naluno";
                                                                                                ...
                                                                                                if($resultsqI2->num_rows>0){
                                                                                                    ...
                                                                                                    // print_r($row);
                                                                                                    $notas=$row2['notatrabdesenvolvido'];
