                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block tab-icon">
                                                            ...
                                                            <div class="col-lg-12 tab-with-img">
                                                                <div class="sub-title">Dados pessoais dos Professores</div>
                                                                <!-- Nav tabs -->
                                                                ...
                                                                <div class="card">
                                                                        ...
                                                                        if(!isset($_GET['id'])){?>
                                                                            ...
                                                                            <h4 class="sub-title">Inserir Professores</h4>
                                                                                <form class="form-horizontal "action="funcaoprofessor.php" method="post" enctype="multipart/form-data">
                                                                                        <div class="form-group row">
                                                                                            <label class="col-sm-2 col-form-label">Número do Professor</label>
                                                                                            <div class="col-sm-10">
                                                                                                <input id="numeroprofessor" name="numeroprofessor" type="text" class="form-control">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                ...
                                                                                                placeholder="Professor" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                       ...
                                                                                       <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-md-4"> 
                                                                                            <input type="submit"  value="Adicionar Professor" class="btn btn-primary" >
                                                                                            </div>
                                                                                            </div>
                                                                        ...
                                                                        <?php }else{
                                                                             ...
                                                                             if($result->num_rows>0){
                                                                                ...
                                                                                foreach($result as $row){
                                                                                     $nprofessor=$row['Nutilizador'];
                                                                                     $Nomeprofessor=$row['Nomeutilizador'];
                                                                                     $cargo=$row['Cargo'];
                                                                                     $Email=$row['email'];
                                                                                     $img=$row['imagem'];}}?>
                                                                            <h4 class="sub-title">Editar Professores</h4>
                                                                                <form class="form-horizontal "action="funcaoprofessoredit.php?id=<?php echo $naluno?> " method="post" enctype="multipart/form-data">
                                                                                        
                                                                                        <div class="form-group row">
                                                                                            <label class="col-sm-2 col-form-label">Número do Professor</label>
                                                                                            <div class="col-sm-10">
                                                                                                <input id="numeroaluno" value ="<?php echo $nprofessor ?>" name="numeroaluno" type="text" class="form-control" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label class="col-sm-2 col-form-label">Nome do Professor</label>
                                                                                            <div class="col-sm-10">
                                                                                                <input id="nomealuno" name="nomealuno" value ="<?php echo $Nomeprofessor ?>" type="text" class="form-control">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label class="col-sm-2 col-form-label">Email</label>
                                                                                        ...
                                                                                        <div class="table-responsive">
                                                                                            <table class="table table-hover">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <?php
                                                                                                                        include "config.php";
                                                                                                                        $sql = "select * from utilizador where cargo='Professor' ";  
                                                                                                                        $result=$conn->query($sql);
                                                                                                                        $i=0;
                                                                                                                            if($result->num_rows>0){
                                                                                                                                //output data of each row
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <?php
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td><?php echo $Nomeprofessor; ?></td>
                                                                                                                            <td><?php echo $Email; ?></td>
                                                                                                                            <td><a href="?pap=professor&id=<?php echo $nprofessor?>"><i class="ti-pencil"></i></a></td>
                                                                                                                        </tr>
                                                                                                                            <?php
                                                                                                                            }
                                                                                                                        }?>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <?php
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td><?php echo $Nomeprofessor; ?></td>
                                                                                                                            <td><?php echo $Email; ?></td>
                                                                                                                            <td><a href="funcaoprofessordel.php?id=<?php echo $nprofessor?>"><i class="ti-close"></i></a></td>
                                                                                                                        </tr>
                                                                                                                            <?php
                                                                                                                            }
                                                                                                                        }?>
